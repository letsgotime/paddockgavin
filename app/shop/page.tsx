...
export const metadata: Metadata = {
  title: "The Shop · Rancho Jaramillo and PaddockGavin",
  description:
  ...
  openGraph: {
    title: "The Shop · Rancho Jaramillo and PaddockGavin",
    description: "Western graphic tees, caps, mugs and bags under the Rancho Jaramillo and PaddockGavin marks. 25% of net profit fills a semi truck with food.",
