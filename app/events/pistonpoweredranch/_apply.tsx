...
const SPONSOR_LEVELS = ["Title Sponsor", "Platinum Sponsor", "Gold Sponsor", "Silver Sponsor", "Bronze Sponsor", "Community Partner", "Not sure yet"]
    ...
    <>
      ...
      <main style={{ background: "#0A1523" }}>
        ...
        <section style={{ position: "relative", minHeight: "clamp(560px,78svh,800px)", display: "flex", alignItems: "flex-end", overflow: "hidden" }}>
          ...
          <div style={{ position: "relative", width: "100%", maxWidth: 1180, margin: "0 auto", padding: "150px clamp(16px,5vw,40px) clamp(40px,8vh,96px)", display: "flex", flexDirection: "column", gap: 16 }}>
