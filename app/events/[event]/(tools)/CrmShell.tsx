    ...
    return (
      <Frame>
        ...
        <div style={{ display: "grid", gap: 11, maxWidth: 380, marginTop: 22 }}>
          {/* Continue with Google is out for now, with its divider. It reached
              the auth service and got a valid redirect back every time and then
              went nowhere, sitting on "Taking you to Google" while the page
              stayed put. A door that looks open and is not is worse than one
              that is plainly shut. The emailed link below is the way in, and it
              is what the copy above already describes. */}
