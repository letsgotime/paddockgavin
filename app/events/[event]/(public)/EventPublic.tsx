    ...
    <main style={{ background: "var(--ink)", minHeight: "100vh", position: "relative" }}>
      ...
      {hero && (
        <nav aria-label="Take part" style={{ borderTop: "1px solid rgba(255,255,255,.12)" }}>
          <div style={{ maxWidth: 1180, margin: "0 auto", padding: "18px clamp(16px,5vw,40px)", display: "flex", flexWrap: "wrap", alignItems: "center", gap: 10 }}>
            <span style={{ fontFamily: MONO, fontSize: 11, letterSpacing: ".22em", textTransform: "uppercase", color: "var(--accent)", marginRight: 6 }}>Take part</span>
            {[
              ...
              <Cta key={c.label} c={c} slug={event.slug} primary={i === 0} />
            ))}
          </div>
        </nav>
      )}
