...
const UPCOMING: EventRow[] = [
  ...
  },
  {
    ...
    venue: "An authorized Patek Philippe and Rolex jeweler",
    place: "Scottsdale, AZ",
    date: null,
    when: "7:30 AM to 10:00 AM",
    entry: "Free to spectate",
    register: "The next date posts here first",
    state: "scoping",
    stateLabel: "Returning, date to be set",
    blurb:
