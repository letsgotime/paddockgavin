        ...
        >
          <span style={{ display: "inline-flex", alignItems: "center", gap: 10, flex: "0 0 auto" }}>
            <i
              aria-hidden="true"
              style={{
                width: 9, height: 9, borderRadius: "50%", background: "#F8B800",
                animation: "pgPulse 2.2s ease-in-out infinite", flex: "0 0 auto", display: "block",
              }}
            />
            <span
              style={{
                fontFamily: "ui-monospace,SFMono-Regular,Menlo,Consolas,monospace",
                fontSize: 12.5, letterSpacing: ".2em", textTransform: "uppercase", color: "#EDF1F6", whiteSpace: "nowrap",
              }}
            >
              Next on the floor
            </span>
          ...
          <span
            style={{
              fontFamily: "ui-monospace,SFMono-Regular,Menlo,Consolas,monospace",
              fontSize: 13, letterSpacing: ".1em", textTransform: "uppercase", color: "#F8B800",
          ...
          <span
            style={{
              fontFamily: "ui-monospace,SFMono-Regular,Menlo,Consolas,monospace",
              fontSize: 13, letterSpacing: ".1em", textTransform: "uppercase", color: "#00D2BE",
      ...
      >
        ...
        >
          <Image
            ...
            fill
            style={{ objectFit: "cover", objectPosition: "center 88%", animation: "pgKb 26s ease-in-out infinite alternate", transformOrigin: "center" }}
            priority
          />
          <span
            aria-hidden="true"
            style={{ position: "absolute", inset: 0, background: "linear-gradient(to top,rgba(10,21,35,.95) 8%,rgba(10,21,35,.34) 55%,rgba(10,21,35,.3) 100%)" }}
          />
          <div
            style={{ position: "relative", padding: "clamp(22px,3.6vw,40px)", display: "flex", flexDirection: "column", gap: 16, maxWidth: 740 }}
          >
            <span
            ...
            <h1
              style={{
                ...
                fontSize: "clamp(34px,6vw,64px)", lineHeight: 1, letterSpacing: "-.028em",
            ...
            <p
              style={{
                margin: 0, fontFamily: "Archivo, Helvetica, sans-serif", fontSize: "clamp(17px,1.7vw,19px)",
                lineHeight: 1.56, color: "#E4E9F0", maxWidth: "56ch", textShadow: "0 1px 10px rgba(10,21,35,.8)",
              }}
            >
            ...
            <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
              ...
              <a
                ...
                style={{
                  ...
                  fontFamily: "Archivo, Helvetica, sans-serif", fontWeight: 700, fontSize: 15,
                  letterSpacing: ".04em", textTransform: "uppercase",
                  color: "#EDF1F6", border: "1px solid rgba(255,255,255,.34)",
                  background: "rgba(10,21,35,.32)", backdropFilter: "blur(8px)",
                  padding: "15px 26px",
                  clipPath: "polygon(0 0,100% 0,100% calc(100% - 11px),calc(100% - 11px) 100%,0 100%)",
                  textDecoration: "none",
                }}
        ...
        <section
          ...
          style={{
            position: "relative",
            background: "linear-gradient(150deg,rgba(248,184,0,.1),rgba(255,255,255,.014))",
          ...
          <div style={{ flex: "6 1 320px", minWidth: 0, display: "flex", flexDirection: "column", gap: 16 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
              ...
              <span
                style={{
                  fontFamily: "ui-monospace,SFMono-Regular,Menlo,Consolas,monospace",
                  fontSize: 12.5, letterSpacing: ".16em", textTransform: "uppercase", color: "#00D2BE",
                }}
              >
                {creatorIn}
              </span>
            ...
            <h2
              style={{
                margin: 0, fontFamily: "Archivo, Helvetica, sans-serif", fontWeight: 900,
                fontSize: "clamp(28px,4.4vw,48px)", lineHeight: 1, letterSpacing: "-.026em",
            ...
            <p
              style={{
                ...
                fontSize: "clamp(16.5px,1.6vw,18px)", lineHeight: 1.58, color: "#DFE5EC", maxWidth: "58ch",
              }}
            >
            ...
            <p
              style={{
                margin: 0, fontFamily: "Archivo, Helvetica, sans-serif",
                fontSize: "clamp(16.5px,1.6vw,18px)", lineHeight: 1.58, color: "#C4CBD6", maxWidth: "58ch",
              }}
            >
            ...
            <div style={{ display: "flex", gap: 10, flexWrap: "wrap", alignItems: "center" }}>
              ...
              <a
                ...
                style={{
                  ...
                  fontFamily: "Archivo, Helvetica, sans-serif", fontWeight: 700, fontSize: 15,
                  letterSpacing: ".04em", textTransform: "uppercase",
                  color: "#EDF1F6", border: "1px solid rgba(255,255,255,.3)", padding: "15px 26px",
                  clipPath: "polygon(0 0,100% 0,100% calc(100% - 11px),calc(100% - 11px) 100%,0 100%)",
                  textDecoration: "none",
                }}
              >
            ...
            {[
              ...
              <div
                ...
                style={{
                  ...
                  position: "relative", marginTop: img.mt,
                }}
              >
          ...
          {EVENTS.map((e) => {
            ...
            return (
              ...
              >
                ...
                <div
                  style={{
                    flex: "0 0 auto", alignSelf: "center", display: "flex",
                    flexDirection: "column", alignItems: "center", gap: 2, minWidth: 64,
                  }}
                >
                ...
                <div style={{ flex: "2 1 220px", minWidth: 0, alignSelf: "center", display: "flex", flexDirection: "column", gap: 8 }}>
                  {[
                    ...
                    { k: "Entry", v: e.entry,         vTone: entryTone },
                  ].map(row => (
                    <span key={row.k} style={{ display: "flex", alignItems: "baseline", gap: 9 }}>
                      <span style={{ fontFamily:"ui-monospace,SFMono-Regular,Menlo,Consolas,monospace", fontSize:11.5, letterSpacing:".18em", textTransform:"uppercase", color:"#91918F", flex:"0 0 auto" }}>{row.k}</span>
                      <i aria-hidden="true" style={{ flex:"1 1 auto", height:0, borderBottom:"1px dotted rgba(255,255,255,.2)", display:"block" }} />
                      <span style={{ fontFamily:"ui-monospace,SFMono-Regular,Menlo,Consolas,monospace", fontSize:12.5, letterSpacing:".1em", textTransform:"uppercase", color:row.vTone, flex:"0 0 auto" }}>{row.v}</span>
                    </span>
                  ))}
                  <div style={{ marginTop: 6 }}>
                    <Link
                      ...
                      style={{
                        display: "inline-flex", alignItems: "center",
                        fontFamily: "Archivo,Helvetica,sans-serif", fontWeight: 700, fontSize: 13.5,
                        letterSpacing: ".06em", textTransform: "uppercase",
                        background: e.tone, color: "#101010", padding: "12px 20px",
        ...
        >
          <Image
            src="/images/urus-deck.webp"
            alt="On the duPont REGISTRY Logistics deck, strapped and going"
            fill
          ...
          <div style={{ position: "absolute", left: 0, right: 0, bottom: 0, padding: "0 clamp(12px,4vw,40px)" }}>
            <div style={{ maxWidth: 1180, margin: "0 auto", padding: "0 0 20px", display: "flex", alignItems: "center", gap: 11 }}>
              ...
              >
                On the duPont REGISTRY Logistics deck, strapped and going
              </span>
            </div>
          </div>
        </section>
        ...
        >
          <Image
            ...
            aria-hidden
            fill
            style={{ objectFit: "cover", opacity: 0.2, zIndex: -1 }}
          />
          <span
            aria-hidden="true"
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "clamp(20px,3vw,40px)" }}>
            <div style={{ flex: "4 1 280px", minWidth: 0, display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              >
                Private events &middot; your date
              </span>
              <h2
                style={{
                  margin: 0, fontFamily: "Archivo, Helvetica, sans-serif", fontWeight: 900,
                  fontSize: "clamp(26px,3.8vw,42px)", lineHeight: 1.02, letterSpacing: "-.024em",
                  textTransform: "uppercase", color: "#FFFFFF", maxWidth: "16ch",
                }}
              >
                Your event, on duPont REGISTRY&rsquo;s floor
              </h2>
              <p
                style={{
                  margin: 0, fontFamily: "Archivo, Helvetica, sans-serif", fontSize: 17,
                  lineHeight: 1.58, color: "#CFE4F4", maxWidth: "50ch",
                }}
              >
                The room is duPont&rsquo;s, in Lebanon, and booking it out is part of my job. It&rsquo;s not just the room that makes it special &mdash; it&rsquo;s what&rsquo;s passing through while you&rsquo;re there. Send a date and I&rsquo;ll check it.
              </p>
              <a
                href="https://ig.me/m/itspaddockgavin"
                target="_blank"
                ...
                style={{
                  ...
                  letterSpacing: ".06em", textTransform: "uppercase",
                  color: "#FFFFFF", border: "1px solid rgba(255,255,255,.4)", padding: "13px 22px",
                  clipPath: "polygon(0 0,100% 0,100% calc(100% - 9px),calc(100% - 9px) 100%,0 100%)",
                  textDecoration: "none",
                }}
              >
            ...
            <div style={{ flex: "5 1 300px", minWidth: 0, display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              <label style={{ display: "flex", flexDirection: "column", gap: 7 }}>
                ...
                <textarea
                  ...
                  placeholder="Headcount, the occasion, anything else"
