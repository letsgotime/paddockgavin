      ...
      <section style={{ position: "relative", overflow: "hidden", isolation: "isolate", display: "flex", flexDirection: "column", justifyContent: "flex-end", minHeight: "66svh" }}>
        ...
        <div style={{ position: "relative", zIndex: 2, padding: "clamp(20px,5vw,40px)", maxWidth: 1080, margin: "0 auto", width: "100%" }}>
          ...
          <h1 style={{ margin: "0 0 16px", fontWeight: 900, fontSize: "clamp(38px,6vw,74px)", lineHeight: 1.02, letterSpacing: "-.02em", textTransform: "uppercase", color: "#FFFFFF", fontFamily: arch }}>
            ...
            <span style={{ display: "block", color: "#F8B800" }}>Twenty-five hours.</span>
          </h1>
      ...
      <section style={{ padding: "clamp(48px,8vw,88px) clamp(20px,5vw,40px)" }}>
        <div style={{ maxWidth: 1080, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(min(320px,100%),1fr))", gap: "clamp(24px,4vw,52px)", alignItems: "center" }}>
          <div>
            ...
            <h2 style={{ margin: "0 0 14px", fontWeight: 900, fontSize: "clamp(28px,3vw,40px)", lineHeight: 1.05, letterSpacing: "-.02em", textTransform: "uppercase", color: "#FFFFFF", fontFamily: arch }}>What the sun hides</h2>
      ...
      <section style={{ background: "#0A1523", padding: "clamp(48px,8vw,88px) clamp(20px,5vw,40px)" }}>
        <div style={{ maxWidth: 1080, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(min(320px,100%),1fr))", gap: "clamp(24px,4vw,52px)", alignItems: "center" }}>
          ...
          <div>
            ...
            <h2 style={{ margin: "0 0 14px", fontWeight: 900, fontSize: "clamp(28px,3vw,40px)", lineHeight: 1.05, letterSpacing: "-.02em", textTransform: "uppercase", color: "#FFFFFF", fontFamily: arch }}>Panel by panel</h2>
      ...
      <section style={{ padding: "clamp(48px,8vw,88px) clamp(20px,5vw,40px)" }}>
        <div style={{ maxWidth: 1080, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(min(320px,100%),1fr))", gap: "clamp(24px,4vw,52px)", alignItems: "center" }}>
          <div>
            ...
            <h2 style={{ margin: "0 0 14px", fontWeight: 900, fontSize: "clamp(28px,3vw,40px)", lineHeight: 1.05, letterSpacing: "-.02em", textTransform: "uppercase", color: "#FFFFFF", fontFamily: arch }}>ECS conversion</h2>
      ...
      <section style={{ padding: "0 clamp(20px,5vw,40px) clamp(48px,8vw,88px)" }}>
        <div style={{ maxWidth: 1080, margin: "0 auto", background: "#152538", border: "1px solid #27384F", clipPath: "polygon(0 0,100% 0,100% calc(100% - 22px),calc(100% - 22px) 100%,0 100%)", padding: "clamp(24px,4vw,34px)", display: "flex", flexWrap: "wrap", gap: 20, alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ flex: "1 1 320px" }}>
            <h2 style={{ margin: "0 0 8px", fontWeight: 900, fontSize: "clamp(24px,2.6vw,34px)", lineHeight: 1.05, letterSpacing: "-.02em", textTransform: "uppercase", color: "#FFFFFF", fontFamily: arch }}>The method is written down</h2>
