      ...
      <main style={{ flex: "1 1 auto", display: "flex", alignItems: "center", justifyContent: "center", padding: "clamp(20px,5vw,40px)" }}>
        <div style={{ position: "relative", maxWidth: 640, width: "100%", background: "#152538", border: "1px solid #27384F", clipPath: "polygon(0 0,100% 0,100% calc(100% - 22px),calc(100% - 22px) 100%,0 100%)", padding: "clamp(28px,5vw,48px)" }}>
          ...
          <h1 style={{ margin: "0 0 14px", fontWeight: 900, fontSize: "clamp(30px,5vw,44px)", lineHeight: 1.04, letterSpacing: "-.02em", textTransform: "uppercase", color: "#FFFFFF" }}>
            ...
            <span style={{ display: "block", color: "#F8B800" }}>Nothing parked here.</span>
          </h1>
          ...
          <Link href="/" style={{ display: "inline-flex", alignItems: "center", fontWeight: 800, fontSize: 14, letterSpacing: ".05em", textTransform: "uppercase", background: "#F8B800", color: "#101010", padding: "14px 24px", clipPath: "polygon(0 0,100% 0,100% calc(100% - 11px),calc(100% - 11px) 100%,0 100%)", textDecoration: "none" }}>
            Back to the paddock
          </Link>
          ...
          <div style={{ margin: "28px 0 0", padding: "22px 0 0", borderTop: "1px solid #27384F", display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(min(150px,46%),1fr))", gap: 10 }}>
            {[
              ...
              { href: "/cars", label: "The garage", icon: <i aria-hidden="true" style={{ flexShrink: 0, width: 13, height: 13, background: "#F8B800", transform: "rotate(45deg)", display: "block" }} />, accent: "#F8B800" },
              ...
              { href: "/donuts", label: "Donuts", icon: <i aria-hidden="true" style={{ flexShrink: 0, width: 14, height: 14, borderRadius: "50%", border: "4px solid #F8B800", display: "block" }} />, accent: "#F8B800" },
