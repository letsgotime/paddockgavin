...
const SHOTS = [
  ...
  { src: "/images/g993-cabin.webp",           caption: "Gunther Werks 993 interior",      pos: "center 50%" },
  { src: "/images/f458-seats.webp",           caption: "Ferrari 458 racing interior",      pos: "center 50%" },
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: "clamp(6px,1vw,10px)" }}>
        {SHOTS.map((s) => (
          <Link key={s.src} href="/gallery" style={{ position: "relative", display: "block", aspectRatio: "3/2", overflow: "hidden", background: "rgba(21,37,56,.4)", textDecoration: "none" }}>
            ...
            <span style={{ position: "absolute", bottom: 7, right: 10, fontFamily: "ui-monospace,SFMono-Regular,Menlo,Consolas,monospace", fontSize: 10, letterSpacing: ".08em", textTransform: "uppercase", color: "rgba(255,255,255,0.82)", pointerEvents: "none" }}>
              &copy; PaddockGavin
            </span>
          </Link>
        ))}
